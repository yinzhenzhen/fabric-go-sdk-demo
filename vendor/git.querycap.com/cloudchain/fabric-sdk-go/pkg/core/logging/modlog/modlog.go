...
import (
	...
	"git.querycap.com/cloudchain/fabric-sdk-go/pkg/core/logging/metadata"
)
...
func hasLoggerFnPrefix(pkgPath string, fnName string) bool {
	const (
		loggingAPIPath = "git.querycap.com/cloudchain/fabric-sdk-go/pkg/core/logging/"
		loggingAPIPkg  = "api" // Go < 1.12
		modlogFnPrefix = "modlog.(*Log)."
		loggingPath    = "git.querycap.com/cloudchain/fabric-sdk-go/pkg/common/"
		loggingPkg     = "logging"
		logBridgePath  = "git.querycap.com/cloudchain/fabric-sdk-go/internal/github.com/hyperledger/fabric-ca/sdkpatch/logbridge"
