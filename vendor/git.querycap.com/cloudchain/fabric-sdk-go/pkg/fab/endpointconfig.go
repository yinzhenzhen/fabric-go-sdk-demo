...
import (
	...
	commtls "git.querycap.com/cloudchain/fabric-sdk-go/pkg/core/config/comm/tls"
	"git.querycap.com/cloudchain/fabric-sdk-go/pkg/core/config/cryptoutil"
	"git.querycap.com/cloudchain/fabric-sdk-go/pkg/core/config/endpoint"
	"git.querycap.com/cloudchain/fabric-sdk-go/pkg/core/config/lookup"
	"git.querycap.com/cloudchain/fabric-sdk-go/pkg/core/cryptosuite"
...
func detectDeprecatedNetworkConfig(endpointConfig *EndpointConfig) {
	...
	for _, v := range endpointConfig.networkConfig.Channels {
		if len(v.Orderers) > 0 {
			...
			logger.Warn("visit https://git.querycap.com/cloudchain/fabric-sdk-go/blob/master/test/fixtures/config/overrides/local_entity_matchers.yaml for samples")
			break
		}
	}
}
