...
import (
	...
	"git.querycap.com/cloudchain/chain-sdk-go/internal/github.com/hyperledger/fabric/protoutil"
...
func DecodeBlock(in *common.Block) (*Block, error) {
	if in == nil {
		return nil, nil
	}
	out := &Block{}
	...
	outBlockHash := protoutil.BlockHeaderHash(in.Header)
